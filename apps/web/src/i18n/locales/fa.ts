...
export const fa: Dict = {
  ...
  'fileViewer.shareMenuPublishOnline': 'روش‌های انتشار دیگر',
  ...
  'fileViewer.shareMenuPublishViaOd': 'انتشار از طریق Open Design',
  ...
  'fileViewer.publishSingleFileTitle': 'انتشار و دریافت پیوند',
  'fileViewer.publishSingleFileDescription': 'هر کسی که پیوند را داشته باشد می‌تواند آن را آنلاین ببیند. در حال حاضر فقط یک فایل قابل انتشار است — منابع محلی جاسازی‌شده مانند تصاویر هنوز پشتیبانی نمی‌شوند.',
  ...
  'fileViewer.publishFileFailed': 'انتشار ناموفق بود. دوباره تلاش کنید یا از گزینه‌های استقرار در پایین استفاده کنید.',
