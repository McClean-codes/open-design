...
export const zhCN: Dict = {
  ...
  "workspaceInvite.visibilityAnswer": "团队成员可以看到你共享到团队空间的设计；保存在「草稿」中的私人设计不会对其他人可见。",
  ...
  "workspaceSwitcher.draftsTooltip": "草稿",
  "workspaceSwitcher.allProjectsTooltip": "全部项目",
  ...
  "recentProjects.moveToTeamDescPost": "，只有创建者可以编辑。该操作可在「全部项目」中找到。",
