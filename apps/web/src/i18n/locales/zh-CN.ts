...
export const zhCN: Dict = {
  ...
  "chat.amrBalanceGate.benefit1": "图片与视频模型官方托管，无需 API Key",
  "chat.amrBalanceGate.benefit2": "自带 SOTA Design Agent，零配置",
  "chat.amrBalanceGate.benefit3": "官方服务，稳定有保障",
  "chat.amrBalanceGate.benefit4": "每次生成前明确展示美元费用",
  ...
  "chat.amrArtifactUpgrade.message": "解锁官方托管的图片与视频模型、更强设计智能体、更多任务并发和更高每月额度。",
  "chat.amrArtifactUpgrade.benefit1": "图片与视频模型，无需配置 API Key",
  "chat.amrArtifactUpgrade.benefit2": "任务并发最高提升 10 倍",
  "chat.amrArtifactUpgrade.benefit3": "月度积分最高提升 300 倍",
  "chat.amrArtifactUpgrade.benefit4": "生成前展示固定费用，失败或取消不扣额度",
