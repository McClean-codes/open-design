...
export const zhCN: Dict = {
  ...
  "fileViewer.shareMenuPublishOnline": "更多发布方式",
  ...
  "fileViewer.shareMenuPublishViaOd": "通过 Open Design 发布",
  ...
  "fileViewer.publishSingleFileDescription": "任何拿到链接的人都可在线查看。目前仅支持发布单个文件，内嵌图片等本地资源暂不支持。",
