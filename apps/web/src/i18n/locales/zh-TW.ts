...
export const zhTW: Dict = {
  ...
  "chat.amrBalanceGate.benefit1": "圖片與影片模型官方託管，無需 API Key",
  "chat.amrBalanceGate.benefit2": "自帶 SOTA Design Agent，零設定",
  "chat.amrBalanceGate.benefit3": "官方服務，穩定有保障",
  "chat.amrBalanceGate.benefit4": "每次生成前明確顯示美元費用",
  ...
  "chat.amrArtifactUpgrade.message": "解鎖官方託管的圖片與影片模型、更強設計智慧體、更多任務並行和更高每月額度。",
  "chat.amrArtifactUpgrade.benefit1": "圖片與影片模型，無需設定 API Key",
  "chat.amrArtifactUpgrade.benefit2": "任務並行處理最高提升 10 倍",
  "chat.amrArtifactUpgrade.benefit3": "每月積分最高提升 300 倍",
  "chat.amrArtifactUpgrade.benefit4": "生成前顯示固定費用，失敗或取消不扣額度",
  ...
  "settings.onboardingLocalBody":
    "使用已安裝的 CLI，如 Claude Code、Codex、Cursor、Gemini 或 OpenCode。",
  ...
  'common.dismiss': '關閉',
  'chat.amrBalanceGate.generationPrice': '本次生成',
