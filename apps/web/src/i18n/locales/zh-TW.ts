...
export const zhTW: Dict = {
  ...
  "fileViewer.shareMenuPublishOnline": "更多發布方式",
  ...
  "fileViewer.shareMenuPublishViaOd": "透過 Open Design 發布",
  ...
  "fileViewer.publishSingleFileDescription": "任何取得連結的人都可以線上查看。目前僅支援發布單一檔案，內嵌圖片等本地資源暫不支援。",
