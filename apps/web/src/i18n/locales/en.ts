...
export const en: Dict = {
  ...
  'chat.amrBalanceGate.benefit1': 'Hosted image and video models — no API keys',
  ...
  'chat.amrBalanceGate.benefit4': 'Fixed USD prices shown before every media generation',
  ...
  'chat.amrArtifactUpgrade.message': 'Unlock hosted image and video models, stronger design agents, more parallel tasks, and more monthly allowance.',
  'chat.amrArtifactUpgrade.benefit1': 'Hosted image and video models, no API key setup',
  ...
  'chat.amrArtifactUpgrade.benefit4': 'Fixed prices before generation; failures and cancellations are not charged',
  ...
  'chat.amrBalanceGate.generationPrice': 'This generation',
