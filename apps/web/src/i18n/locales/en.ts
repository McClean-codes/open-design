...
export const en: Dict = {
  ...
  'fileViewer.shareMenuPublishOnline': 'MORE WAYS TO PUBLISH',
  ...
  'fileViewer.shareMenuPublishViaOd': 'PUBLISH VIA OPEN DESIGN',
  ...
  'fileViewer.publishSingleFileTitle': 'Publish & get a link',
  'fileViewer.publishSingleFileDescription': 'Anyone with the link can view it online. Only a single file can be published for now — embedded local assets such as images aren\'t supported yet.',
  ...
  'fileViewer.publishFileFailed': 'Publish failed. Try again, or use a deploy option below.',
