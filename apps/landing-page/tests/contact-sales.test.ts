...
describe("contact-sales canonical KV intake", () => {
  ...
  it("keeps production and staging on independent CONTACT_LEADS namespaces and documents the Vela secret on the preview config", async () => {
    ...
    assert.match(staging, /CONTACT_SALES_SERVICE_SECRET/);
